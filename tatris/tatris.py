...
def draw_next_shape(piece, surface):
    ...
    label = font.render('DALSI     TVAR', 1, (0, 0, 0))
...
def draw_window(surface, grid, score=0, last_score=0):
    ...
    background_image = pygame.image.load("background.png")  # Replace "background.jpg" with the path to your image
    ...
    label = font.render('TATRIS', 1, (0, 0, 0))  # initialise 'Tetris' text with white

    surface.blit(label, ((top_left_x + play_width / 2) - (label.get_width() / 2), 30))  # put surface on the center of the window

    # current score
    font = pygame.font.Font(fontpath, 30)
    label = font.render('SKORE   ' + str(score), 1, (0, 0, 0))
    ...
    # last score
    label_hi1 = font.render('NAJVACSIE  ', 1, (0, 0, 0))
    label_hi2 = font.render('SKORE   ', 1, (0, 0, 0))
    label_hi3 = font.render(str(last_score), 1, (0, 0, 0))   
...
def main_menu(window):
    run = True
    while run:
        draw_text_middle('Stlac   lubovolne   tlacidlo', 50, (255, 255, 255), window)
        pygame.display.update()
